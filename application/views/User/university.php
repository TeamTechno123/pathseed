                  ...
                  <div class="col-md-12 ">
                    <div class="row">
                      ...
                      <div class="form-group col-md-12">
                        ...
                        <input type="text" class="form-control form-control-sm" name="blog_name" id="blog_name" value="<?php if(isset($service_info)){ echo $service_info['blog_name']; } ?>" placeholder="Enter University Name" required>
                      </div>
