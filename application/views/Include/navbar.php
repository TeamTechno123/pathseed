<?php
  ...
  $company_info = $this->User_Model->get_info_arr_fields('company_name','company_id', $path_company_id, 'company');
  $user_info = $this->User_Model->get_info_arr_fields('user_name','user_id', $path_user_id, 'user');
?>
      ...
      <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
        ...
        <li class="nav-item has-treeview">
          ...
          <ul class="nav nav-treeview" style="display: none;">
            ...
            <li class="nav-item">
              <a href="<?php echo base_url(); ?>User/organization_list" class="nav-link">
                <i class="far fa-circle nav-icon"></i>
                <p>
                  Organization Info.
                </p>
            ...
            <li class="nav-item">
              <a href="<?php echo base_url(); ?>User/blog_list" class="nav-link">
                <i class="far fa-circle nav-icon"></i>
                <p>Bolg Information</p>
              </a>
            </li>
            <li class="nav-item">
              <a href="<?php echo base_url(); ?>User/country_list" class="nav-link">
                <i class="far fa-circle nav-icon"></i>
                <p>Country</p>
              </a>
            </li>
            <li class="nav-item">
              <a href="<?php echo base_url(); ?>User/service_list" class="nav-link">
                <i class="far fa-circle nav-icon"></i>
                <p>Service</p>
              </a>
            </li>
            ...
            <li class="nav-item">
              <a href="<?php echo base_url(); ?>User/stream_list" class="nav-link">
                <i class="far fa-circle nav-icon"></i>
                <p>Stream</p>
              </a>
            </li>
            ...
            <li class="nav-item">
              <a href="<?php echo base_url(); ?>User/testimonial_list" class="nav-link">
                <i class="far fa-circle nav-icon"></i>
                <p>Testimonial</p>
              </a>
            </li>
            ...
            <li class="nav-item">
              <a href="<?php echo base_url(); ?>User/university_list" class="nav-link">
                <i class="far fa-circle nav-icon"></i>
                <p>University</p>
              </a>
            </li>
