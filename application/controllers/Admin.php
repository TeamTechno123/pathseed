...
class Admin extends CI_Controller{
    ...
    if ($this->form_validation->run() == FALSE) {
      ...
      if($login == null){
        ...
        foreach ($login as $login){
          $this->session->set_userdata('path_admin_id', $login['admin_id']);
        }
  ...
  public function dashboard(){
    $path_admin_id = $this->session->userdata('path_admin_id');
    if($path_admin_id == ''){ header('location:'.base_url().'Admin'); }
